...
export const COMMAND_DOCS: CommandDoc[] = [
  ...
  { name: '/banking balance', summary: 'View the deposit balance for your registered nation.', category: 'core' },
  { name: '/banking withdraw [resources]', summary: 'Withdraw resources from offshore to your registered nation balance.', category: 'core' },
  { name: '/banking alliance_balance', summary: 'Leader/admin command to view alliance-held and unregistered deposit balances.', category: 'gov' },
  ...
  { name: '/banking user_balances', summary: 'ADMIN_DISCORD_IDS-only command to view every tracked nation balance.', category: 'admin' },
  { name: '/banking set_api_keys <alliance_bank_api_key> <offshore_api_key>', summary: 'Set guild banking API keys (ADMIN_DISCORD_IDS only).', category: 'admin' },
