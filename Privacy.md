...
## How to finish this document (remove before publishing)

This draft was generated by mapping the Privacy Policy to what the codebase actually does (accounts,
password hashing, PnW API key encryption, chat retention, push subscriptions, analytics counters,
Discord OAuth). Before publishing:
